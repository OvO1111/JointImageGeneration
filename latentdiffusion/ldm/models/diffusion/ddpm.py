...
class DDPM(pl.LightningModule):
    ...
    def __init__(self,
        ...
        self.image_size = image_size if isinstance(image_size, int) else tuple(image_size)  # try conv?
...
class LatentDiffusion(DDPM):
    ...
    def __init__(self,
                 ...
                 dims=3,
                 *args, **kwargs):
        self.no_first_stage = first_stage_config == "__is_no_first_stage__"
    ...
    def decode_first_stage(self, z, predict_cids=False, force_not_quantize=False):
        if self.no_first_stage: return z
        if predict_cids:
            if z.dim() == 4:
    ...
    def sample(self, cond, batch_size=16, return_intermediates=False, x_T=None,
        ...
        if shape is None:
            shape = (batch_size, self.channels, ) + (self.image_size if isinstance(self.image_size, tuple) else (self.channels, ) * self.dims)
        if cond is not None:
            if isinstance(cond, dict):
                cond = {key: cond[key][:batch_size] if not isinstance(cond[key], list) else
                list(map(lambda x: x[:batch_size], cond[key])) for key in cond}
    ...
    def sample_log(self,cond,batch_size,ddim, ddim_steps,**kwargs):
        ...
        if ddim:
            ...
            shape = (self.channels, ) + (self.image_size if isinstance(self.image_size, tuple) else (self.image_size, ) * self.dims)
